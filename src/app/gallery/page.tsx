      ...
      <div className="min-h-screen bg-[#F4F8FC]">
        ...
        <div className="py-10 px-4 bg-[#F4F8FC]">
          <div className="max-w-7xl mx-auto">
            <p className="text-xs tracking-widest uppercase text-[#1B6CA8] mb-1" style={{ fontFamily: 'Outfit, sans-serif' }}>Our Work</p>
            <h1 className="text-3xl sm:text-4xl font-bold text-[#1A2E42] mb-1" style={{ fontFamily: 'Plus Jakarta Sans, sans-serif' }}>
              Gallery
            </h1>
            <p className="text-[#5A7A99]" style={{ fontFamily: 'Outfit, sans-serif' }}>See our work — frames, custom orders, and showcases</p>
          </div>
        </div>
